...
const publications = [
  ...
  {
    title: 'Satellite Command Systems Security',
  ...
  {
    title: 'AI Space Debris Detection',
    venue: 'IEEE',
    status: 'Under Proceeding',
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {patents.map((patent, index) => (
              <motion.div
                ...
                className="relative card-glass rounded-2xl p-6 overflow-hidden group cursor-pointer perspective-1000"
              >
            ...
            <div className="space-y-8">
              {publications.map((pub, index) => (
                ...
                >
                  ...
                  {/* Card */}
                  <motion.div 
                    className={`w-full lg:w-[calc(50%-4rem)] card-glass rounded-2xl p-6 overflow-hidden group`}
